...
// Mock data for the parent portal: Anderson household (hh-001)
// Emma enrolled in: cls-006, cls-019, cls-067
// Lily enrolled in: cls-029, cls-054

const ENROLLED_CLASS_IDS = ["cls-006", "cls-019", "cls-067", "cls-029", "cls-054"]
...
export default function ParentDashboardPage() {
  const enrolledClasses = classes.filter((cls) => ENROLLED_CLASS_IDS.includes(cls.id))
