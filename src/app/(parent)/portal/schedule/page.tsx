...
import { DISCIPLINE_COLORS, DISCIPLINE_LABELS, DAY_LABELS } from "@/lib/constants"
...
// Map student to their enrolled classes for labeling
const householdStudents = students.filter((s) => s.householdId === HOUSEHOLD_ID)
const enrolledClassIds = householdStudents.flatMap((s) => s.enrolledClassIds)
