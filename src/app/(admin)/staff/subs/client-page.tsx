...
import type { Discipline, SubRequest } from "@/lib/types"
...
interface QualifiedSubCandidate {
  staffId: string
  name: string
  disciplines: Discipline[]
  availabilityMatch: "available" | "check" | "unavailable"
  phone: string
}
...
interface SubManagementClientPageProps {
  subRequests: SubRequest[]
  qualifiedSubCandidates: QualifiedSubCandidate[]
  subHistory: SubHistoryEntry[]
}

export default function SubManagementClientPage({
  subRequests,
