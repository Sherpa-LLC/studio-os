...
export default function BillingPage() {
  ...
  const totalBilled = getMonthlyBilled(CURRENT_MONTH)
  const totalCollected = getMonthlyCollected(CURRENT_MONTH)
  const totalOutstanding = getMonthlyOutstanding(CURRENT_MONTH)
  const totalFailed = getMonthlyFailed(CURRENT_MONTH)
                ...
                {recentInvoices.map((invoice) => (
                  ...
                  >
                    <TableCell className="font-medium">
                      {getHouseholdName(invoice.householdId)}
                    </TableCell>
