...
import type { AgeGroup, DayOfWeek, Discipline, Instructor, Season } from "@/lib/types"
...
interface AddClassClientPageProps {
  instructors: Instructor[]
  seasons: Season[]
}

export default function AddClassClientPage({ instructors, seasons }: AddClassClientPageProps) {
  // Section A: Identity
