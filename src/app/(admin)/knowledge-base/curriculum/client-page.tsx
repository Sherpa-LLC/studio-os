...
function buildLessonPlanCards(curriculumArticles: KnowledgeBaseArticle[]): Record<string, LessonPlanCard[]> {
...
interface CurriculumClientPageProps {
  curriculumArticles: KnowledgeBaseArticle[]
}

export default function CurriculumClientPage({ curriculumArticles }: CurriculumClientPageProps) {
  const [addPlanOpen, setAddPlanOpen] = useState(false)
  const lessonPlans = buildLessonPlanCards(curriculumArticles)
